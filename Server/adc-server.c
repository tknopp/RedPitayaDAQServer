...
//        printf("Sleep\n");
  ...
  else if(pid > 0)
  {
    ...
    while(!interrupted)
    {
      printf("Set to master and enter reset\n");
      /* Set to master */
