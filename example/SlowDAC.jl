...
periods_per_frame = div(40, periods_per_step) # about 0.5 s frame length
frame_period = dec*samples_per_period*periods_per_frame / base_frequency
slow_dac_periods_per_frame = periods_per_frame*4
...
uCurrentPeriod = readData(rp, currFr-2, 6)

sleep(0.1)
currFr = enableSlowDAC(rp, true, 2, frame_period, 0.5)

uCurrentPeriod2 = readData(rp, currFr-2, 6)
