...
set_property IOSTANDARD DIFF_HSTL_I_18 [get_ports adc_enc_p_o];
set_property IOSTANDARD DIFF_HSTL_I_18 [get_ports adc_enc_n_o];
...
set_property PACKAGE_PIN U14 [get_ports {daisy_clk_o_clk_p}]; # p
set_property PACKAGE_PIN U15 [get_ports {daisy_clk_o_clk_n}]; # n

set_property PACKAGE_PIN P14 [get_ports {daisy_p_i}];
set_property PACKAGE_PIN R14 [get_ports {daisy_n_i}];

set_property PACKAGE_PIN N18 [get_ports {daisy_clk_i_clk_p}]; # p
set_property PACKAGE_PIN P19 [get_ports {daisy_clk_i_clk_n}]; # n
