...
# hbridgewaveform, signal_calib, signal_ramp, waveform_gen
...
##################################################################
set bCheckSources 1
set list_bdc_active "hbridgewaveform, signal_calib, signal_ramp, waveform_gen"
...
proc create_hier_cell_waveform_awg1 { parentCell nameHier } {
  ...
  # Create instance: to_32_bit_address, and set properties
  set to_32_bit_address [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 to_32_bit_address ]
  set_property -dict [ list \
   CONFIG.IN0_WIDTH {2} \
   CONFIG.NUM_PORTS {3} \
 ] $to_32_bit_address
  ...
  connect_bd_net -net element_slice_Dout [get_bd_pins element_slice/Dout] [get_bd_pins to_32_bit_address/In1]
  connect_bd_net -net enable_read_constant_dout [get_bd_pins blk_mem_gen_0/enb] [get_bd_pins enable_read_constant/dout]
  ...
  connect_bd_net -net xlconcat_1_dout [get_bd_pins blk_mem_gen_0/addrb] [get_bd_pins to_32_bit_address/dout]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins to_32_bit_address/In2] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins to_32_bit_address/In0] [get_bd_pins xlconstant_1/dout]
...
proc create_hier_cell_waveform_awg { parentCell nameHier } {
  ...
  connect_bd_net -net xlconstant_0_dout1 [get_bd_pins to_32_bit_address/In2] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins to_32_bit_address/In0] [get_bd_pins xlconstant_1/dout]
...
proc create_hier_cell_signal_compose1 { parentCell nameHier } {
  ...
  connect_bd_net -net clk_wiz_0_clk_internal [get_bd_pins aclk] [get_bd_pins signal_calib_0/aclk] [get_bd_pins signal_composer_0/clk] [get_bd_pins signal_ramp_0/aclk] [get_bd_pins waveform_awg1/aclk] [get_bd_pins waveform_gen_0/aclk] [get_bd_pins waveform_gen_1/aclk] [get_bd_pins waveform_gen_2/aclk]
  ...
  connect_bd_net -net resync_dac_1 [get_bd_pins resync_dac] [get_bd_pins waveform_gen_0/resync] [get_bd_pins waveform_gen_1/resync] [get_bd_pins waveform_gen_2/resync]
  connect_bd_net -net rst_ps7_0_125M_peripheral_aresetn [get_bd_pins aresetn] [get_bd_pins signal_ramp_0/aresetn] [get_bd_pins waveform_awg1/aresetn] [get_bd_pins waveform_gen_0/aresetn] [get_bd_pins waveform_gen_1/aresetn] [get_bd_pins waveform_gen_2/aresetn]
  connect_bd_net -net signal_calib_0_signal_out [get_bd_pins S] [get_bd_pins signal_calib_0/signal_out]
  connect_bd_net -net signal_cfg_slice_0_calib_limit_lower [get_bd_pins signal_calib_0/limit_lower] [get_bd_pins signal_cfg_slice_0/calib_limit_lower]
  connect_bd_net -net signal_cfg_slice_0_calib_limit_upper [get_bd_pins signal_calib_0/limit_upper] [get_bd_pins signal_cfg_slice_0/calib_limit_upper]
  ...
  connect_bd_net -net signal_cfg_slice_0_calib_scale [get_bd_pins signal_cfg_slice_0/calib_scale]
  ...
  connect_bd_net -net signal_cfg_slice_0_comp_3_freq [get_bd_pins signal_cfg_slice_0/comp_3_freq] [get_bd_pins waveform_awg1/freq]
  connect_bd_net -net signal_cfg_slice_0_comp_3_phase [get_bd_pins signal_cfg_slice_0/comp_3_phase] [get_bd_pins waveform_awg1/phase]
  ...
  connect_bd_net -net waveform_awg1_S [get_bd_pins signal_composer_0/wave3] [get_bd_pins waveform_awg1/S]
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_pins signal_composer_0/valid3] [get_bd_pins xlconstant_0/dout]
...
proc create_hier_cell_signal_compose { parentCell nameHier } {
  ...
  # Create port connections
  connect_bd_net -net Din_1 [get_bd_pins Din] [get_bd_pins signal_cfg_slice_0/cfg_data]
  connect_bd_net -net aclk_1 [get_bd_pins aclk] [get_bd_pins signal_calib_0/aclk] [get_bd_pins signal_composer_0/clk] [get_bd_pins signal_ramp/aclk] [get_bd_pins waveform_awg/aclk] [get_bd_pins waveform_gen_0/aclk] [get_bd_pins waveform_gen_1/aclk] [get_bd_pins waveform_gen_2/aclk]
  connect_bd_net -net aresetn_1 [get_bd_pins aresetn] [get_bd_pins signal_ramp/aresetn] [get_bd_pins waveform_awg/aresetn] [get_bd_pins waveform_gen_0/aresetn] [get_bd_pins waveform_gen_1/aresetn] [get_bd_pins waveform_gen_2/aresetn]
  ...
  connect_bd_net -net signal_cfg_slice_0_comp_2_freq [get_bd_pins signal_cfg_slice_0/comp_2_freq] [get_bd_pins waveform_gen_2/freq]
  connect_bd_net -net signal_cfg_slice_0_comp_2_phase [get_bd_pins signal_cfg_slice_0/comp_2_phase] [get_bd_pins waveform_gen_2/phase]
  connect_bd_net -net signal_cfg_slice_0_comp_3_freq [get_bd_pins signal_cfg_slice_0/comp_3_freq] [get_bd_pins waveform_awg/freq]
  connect_bd_net -net signal_cfg_slice_0_comp_3_phase [get_bd_pins signal_cfg_slice_0/comp_3_phase] [get_bd_pins waveform_awg/phase]
  connect_bd_net -net signal_cfg_slice_0_offset [get_bd_pins signal_cfg_slice_0/offset] [get_bd_pins signal_composer_0/offset]
  ...
  connect_bd_net -net waveform_awg_S [get_bd_pins signal_composer_0/wave3] [get_bd_pins waveform_awg/S]
  connect_bd_net -net waveform_gen_0_m_axis_data_tvalid_1 [get_bd_pins signal_composer_0/valid0] [get_bd_pins waveform_gen_0/m_axis_data_tvalid_1]
  connect_bd_net -net waveform_gen_0_wave [get_bd_pins signal_composer_0/wave0] [get_bd_pins waveform_gen_0/wave]
  connect_bd_net -net waveform_gen_1_m_axis_data_tvalid_1 [get_bd_pins signal_composer_0/valid1] [get_bd_pins waveform_gen_1/m_axis_data_tvalid_1]
  connect_bd_net -net waveform_gen_1_wave [get_bd_pins signal_composer_0/wave1] [get_bd_pins waveform_gen_1/wave]
...
proc create_hier_cell_write_to_ram { parentCell nameHier } {
  ...
  create_bd_pin -dir I -type clk aclk
  create_bd_pin -dir O -from 15 -to 0 adc_out_A
  create_bd_pin -dir O -from 15 -to 0 adc_out_B
  create_bd_pin -dir I -type rst aresetn
  create_bd_pin -dir I -from 15 -to 0 decimation
  create_bd_pin -dir I enableFIR
  ...
  # Create instance: bypass_multiplexer_0, and set properties
  set block_name bypass_multiplexer
  set block_cell_name bypass_multiplexer_0
  if { [catch {set bypass_multiplexer_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $bypass_multiplexer_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property -dict [ list \
...
-4.174363282738155e-5, 9.925103405823647e-6} \
  ...
  # Create instance: xlslice_out_A, and set properties
  set xlslice_out_A [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 xlslice_out_A ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {15} \
   CONFIG.DOUT_WIDTH {16} \
 ] $xlslice_out_A

  # Create instance: xlslice_out_B, and set properties
  set xlslice_out_B [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 xlslice_out_B ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {31} \
   CONFIG.DIN_TO {16} \
   CONFIG.DOUT_WIDTH {16} \
...
proc create_hier_cell_system_1 { parentCell nameHier } {
  ...
  set axi_cfg_register_counter_trigger [ create_bd_cell -type ip -vlnv pavel-demin:user:axi_cfg_register:1.0 axi_cfg_register_counter_trigger ]
  set_property -dict [ list \
   CONFIG.AXI_ADDR_WIDTH {32} \
   CONFIG.CFG_DATA_WIDTH {96} \
 ] $axi_cfg_register_counter_trigger
  ...
  # Create instance: axi_sts_register_counter_trigger, and set properties
  set axi_sts_register_counter_trigger [ create_bd_cell -type ip -vlnv pavel-demin:user:axi_sts_register:1.0 axi_sts_register_counter_trigger ]
  set_property -dict [ list \
   CONFIG.AXI_ADDR_WIDTH {32} \
   CONFIG.STS_DATA_WIDTH {64} \
 ] $axi_sts_register_counter_trigger

  # Create instance: axi_sts_register_image_version, and set properties
  set axi_sts_register_image_version [ create_bd_cell -type ip -vlnv pavel-demin:user:axi_sts_register:1.0 axi_sts_register_image_version ]
  set_property -dict [ list \
   CONFIG.AXI_ADDR_WIDTH {32} \
   CONFIG.STS_DATA_WIDTH {32} \
 ] $axi_sts_register_image_version
...
unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned} \
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M07_AXI [get_bd_intf_pins axi_interconnect_0/M07_AXI] [get_bd_intf_pins axi_sts_register_counter_trigger/S_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M08_AXI [get_bd_intf_pins axi_cfg_register_counter_trigger/S_AXI] [get_bd_intf_pins axi_interconnect_0/M08_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M09_AXI [get_bd_intf_pins axi_interconnect_0/M09_AXI] [get_bd_intf_pins axi_sts_register_image_version/S_AXI]
  ...
  connect_bd_net -net trigger_counter_sts_1 [get_bd_pins counter_trigger_sts] [get_bd_pins axi_sts_register_counter_trigger/sts_data]
...
proc create_hier_cell_sequencer { parentCell nameHier } {
  ...
  # Create instance: zero_constant1, and set properties
  set zero_constant1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 zero_constant1 ]
  set_property -dict [ list \
   CONFIG.CONST_VAL {0} \
  ...
  connect_bd_net -net rst_ps7_0_125M_peripheral_aresetn [get_bd_pins aresetn] [get_bd_pins pdm_1/aresetn] [get_bd_pins pdm_2/aresetn] [get_bd_pins pdm_3/aresetn] [get_bd_pins pdm_4/aresetn] [get_bd_pins sequence_slice_0/aresetn] [get_bd_pins sequence_stepper_0/aresetn] [get_bd_pins util_vector_logic_0/Op1]
...
proc create_hier_cell_fourier_synth_standard { parentCell nameHier } {
  ...
  # Create pins
  create_bd_pin -dir I -type clk aclk
  create_bd_pin -dir I -from 1 -to 0 aresetn
  create_bd_pin -dir I bram_aresetn
  ...
  connect_bd_net -net aresetn_1 [get_bd_pins signal_compose1/aresetn] [get_bd_pins xlslice_8/Dout]
  connect_bd_net -net aresetn_2 [get_bd_pins aresetn] [get_bd_pins xlslice_8/Din] [get_bd_pins xlslice_9/Din]
  connect_bd_net -net aresetn_3 [get_bd_pins signal_compose/aresetn] [get_bd_pins xlslice_9/Dout]
...
# Hierarchical cell: counter_trigger
proc create_hier_cell_counter_trigger { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_counter_trigger() - Empty argument(s)!"}
     return
  }
  ...
  set block_cell_name counter_delayed_trig_0
  if { [catch {set counter_delayed_trig_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $counter_delayed_trig_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
...
# Hierarchical cell: DIO
proc create_hier_cell_DIO { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_DIO() - Empty argument(s)!"}
     return
  }
  ...
  create_bd_pin -dir IO ext_DIO5_N
  create_bd_pin -dir IO ext_DIO6_N
  create_bd_pin -dir IO ext_DIO6_P
  create_bd_pin -dir IO ext_DIO7_N
  create_bd_pin -dir IO ext_DIO7_P
  create_bd_pin -dir I -from 1 -to 0 resync

  # Create instance: hbridgewaveform_0, and set properties
  set hbridgewaveform_0 [ create_bd_cell -type container -reference hbridgewaveform hbridgewaveform_0 ]
  set_property -dict [ list \
   CONFIG.ACTIVE_SIM_BD {hbridgewaveform.bd} \
   CONFIG.ACTIVE_SYNTH_BD {hbridgewaveform.bd} \
   CONFIG.ENABLE_DFX {0} \
   CONFIG.LIST_SIM_BD {hbridgewaveform.bd} \
   CONFIG.LIST_SYNTH_BD {hbridgewaveform.bd} \
   CONFIG.LOCK_PROPAGATE {0} \
 ] $hbridgewaveform_0

  # Create instance: hbridgewaveform_1, and set properties
  set hbridgewaveform_1 [ create_bd_cell -type container -reference hbridgewaveform hbridgewaveform_1 ]
  set_property -dict [ list \
   CONFIG.ACTIVE_SIM_BD {hbridgewaveform.bd} \
   CONFIG.ACTIVE_SYNTH_BD {hbridgewaveform.bd} \
   CONFIG.ENABLE_DFX {0} \
  ...
  # Create instance: rp_iobuf_2, and set properties
  set block_name rp_iobuf
  set block_cell_name rp_iobuf_2
  if { [catch {set rp_iobuf_2 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $rp_iobuf_2 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: rp_iobuf_3, and set properties
  set block_name rp_iobuf
  set block_cell_name rp_iobuf_3
  if { [catch {set rp_iobuf_3 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $rp_iobuf_3 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: rp_iobuf_4, and set properties
  set block_name rp_iobuf
  set block_cell_name rp_iobuf_4
  if { [catch {set rp_iobuf_4 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $rp_iobuf_4 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: rp_iobuf_5, and set properties
  set block_name rp_iobuf
  set block_cell_name rp_iobuf_5
  if { [catch {set rp_iobuf_5 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $rp_iobuf_5 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: rp_iobuf_6, and set properties
  set block_name rp_iobuf
  set block_cell_name rp_iobuf_6
  if { [catch {set rp_iobuf_6 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $rp_iobuf_6 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: rp_iobuf_7, and set properties
  set block_name rp_iobuf
  set block_cell_name rp_iobuf_7
  if { [catch {set rp_iobuf_7 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $rp_iobuf_7 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: rp_iobuf_8, and set properties
  set block_name rp_iobuf
  set block_cell_name rp_iobuf_8
  if { [catch {set rp_iobuf_8 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $rp_iobuf_8 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: rp_iobuf_9, and set properties
  set block_name rp_iobuf
  set block_cell_name rp_iobuf_9
  if { [catch {set rp_iobuf_9 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $rp_iobuf_9 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_net -net Net2 [get_bd_pins ext_DIO5_N] [get_bd_pins rp_iobuf_4/val_tri]
  connect_bd_net -net Net3 [get_bd_pins ext_DIO4_N] [get_bd_pins rp_iobuf_5/val_tri]
  connect_bd_net -net Net4 [get_bd_pins ext_DIO3_N] [get_bd_pins rp_iobuf_6/val_tri]
  ...
  connect_bd_net -net hbridgewaveform_1_H2out [get_bd_pins hbridgewaveform_1/H2out] [get_bd_pins util_vector_logic_5/Op2]
  connect_bd_net -net resync_1 [get_bd_pins resync] [get_bd_pins xlslice_22/Din] [get_bd_pins xlslice_29/Din]
  connect_bd_net -net rp_iobuf_2_val_in_clocked [get_bd_pins rp_iobuf_2/val_in_clocked] [get_bd_pins xlconcat_0/In2]
  connect_bd_net -net rp_iobuf_3_val_in_clocked [get_bd_pins rp_iobuf_3/val_in_clocked] [get_bd_pins xlconcat_0/In3]
  connect_bd_net -net rp_iobuf_4_val_in_clocked [get_bd_pins rp_iobuf_4/val_in_clocked] [get_bd_pins xlconcat_0/In4]
  connect_bd_net -net rp_iobuf_5_val_in_clocked [get_bd_pins rp_iobuf_5/val_in_clocked] [get_bd_pins xlconcat_0/In5]
  connect_bd_net -net rp_iobuf_6_val_in_clocked [get_bd_pins rp_iobuf_6/val_in_clocked] [get_bd_pins xlconcat_0/In6]
  ...
  connect_bd_net -net xlslice_10_Dout [get_bd_pins util_vector_logic_4/Op1] [get_bd_pins xlslice_10/Dout]
  connect_bd_net -net xlslice_11_Dout [get_bd_pins util_vector_logic_5/Op1] [get_bd_pins xlslice_11/Dout]
...
proc create_root_design { parentCell } {
  ...
  # Create instance: DIO
  create_hier_cell_DIO [current_bd_instance .] DIO
  ...
  # Create instance: counter_trigger
  create_hier_cell_counter_trigger [current_bd_instance .] counter_trigger
  ...
  # Create instance: proc_sys_reset_fourier_synth1, and set properties
  set proc_sys_reset_fourier_synth1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 proc_sys_reset_fourier_synth1 ]
  ...
  # Create port connections
  connect_bd_net -net DIO_dio_data_clocked [get_bd_pins DIO/dio_data_clocked] [get_bd_pins system/sts_data] [get_bd_pins xlslice_0/Din]
  ...
  connect_bd_net -net Net6 [get_bd_ports ext_DIO7_N] [get_bd_pins DIO/ext_DIO7_N]
  connect_bd_net -net Net7 [get_bd_ports ext_DIO7_P] [get_bd_pins DIO/ext_DIO7_P]
  connect_bd_net -net Net8 [get_bd_ports ext_DIO6_P] [get_bd_pins DIO/ext_DIO6_P]
  connect_bd_net -net Net9 [get_bd_ports ext_DIO6_N] [get_bd_pins DIO/ext_DIO6_N]
  connect_bd_net -net Net10 [get_bd_ports ext_DIO5_N] [get_bd_pins DIO/ext_DIO5_N]
  connect_bd_net -net Net11 [get_bd_ports ext_DIO4_N] [get_bd_pins DIO/ext_DIO4_N]
  connect_bd_net -net Net12 [get_bd_ports ext_DIO3_N] [get_bd_pins DIO/ext_DIO3_N]
  connect_bd_net -net Net13 [get_bd_ports ext_DIO2_N] [get_bd_pins DIO/ext_DIO2_N]
  ...
  connect_bd_net -net proc_sys_reset_fourier_synth1_peripheral_aresetn [get_bd_pins proc_sys_reset_fourier_synth1/peripheral_aresetn] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net proc_sys_reset_fourier_synth_peripheral_aresetn [get_bd_pins proc_sys_reset_fourier_synth/peripheral_aresetn] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net proc_sys_reset_pdm_peripheral_aresetn [get_bd_pins DIO/aresetn] [get_bd_pins proc_sys_reset_pdm/peripheral_aresetn] [get_bd_pins sequencer/aresetn]
  ...
  connect_bd_net -net reset_manager_0_fourier_synth_aresetn [get_bd_pins proc_sys_reset_fourier_synth/ext_reset_in] [get_bd_pins reset_manager_0/fourier_synth_aresetn_1]
  connect_bd_net -net reset_manager_0_fourier_synth_aresetn_2 [get_bd_pins proc_sys_reset_fourier_synth1/ext_reset_in] [get_bd_pins reset_manager_0/fourier_synth_aresetn_2]
  ...
  connect_bd_net -net sequencer_enable_dac [get_bd_pins DIO/enable_dac] [get_bd_pins fourier_synth_standard/enable_dac] [get_bd_pins sequencer/enable_dac]
  connect_bd_net -net sequencer_resync_dac [get_bd_pins DIO/resync] [get_bd_pins fourier_synth_standard/resync_dac] [get_bd_pins sequencer/resync_dac]
  ...
  connect_bd_net -net system_cfg_data [get_bd_pins DIO/cfg_dac] [get_bd_pins fourier_synth_standard/cfg_data] [get_bd_pins system/dac_cfg]
  connect_bd_net -net system_cfg_data1 [get_bd_pins DIO/cfg_in] [get_bd_pins system/cfg_data] [get_bd_pins xlslice_1/Din] [get_bd_pins xlslice_2/Din] [get_bd_pins xlslice_3/Din] [get_bd_pins xlslice_4/Din] [get_bd_pins xlslice_6/Din]
  connect_bd_net -net system_counter_trigger_cfg [get_bd_pins counter_trigger/counter_trigger_cfg] [get_bd_pins system/counter_trigger_cfg]
  ...
  connect_bd_net -net xlslice_4_Dout [get_bd_pins write_to_ram/enableFIR] [get_bd_pins xlslice_4/Dout]
  ...
  assign_bd_address -offset 0x40009000 -range 0x00001000 -target_address_space [get_bd_addr_spaces system/processing_system7_0/Data] [get_bd_addr_segs system/axi_sts_register_image_version/s_axi/reg0] -force
