...
referencedesigner.com:user:clk_div:1.0\
...
jbeuke:user:pdm_value_supply:1.0\
...
jbeuke:user:fourier_synthesizer:1.0\
"
...
proc create_hier_cell_fourier_synth_standard { parentCell nameHier } {
  ...
  # Create interface pins
  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 M_AXIS_PHASE_A

  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 M_AXIS_PHASE_B

  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 m_axis_signal_A

  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 m_axis_signal_B


  # Create pins
  create_bd_pin -dir I -type clk aclk
  create_bd_pin -dir O -from 15 -to 0 amplitude_A
  create_bd_pin -dir O -from 15 -to 0 amplitude_B
  ...
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins M_AXIS_PHASE_A] [get_bd_intf_pins dds_compiler_A_channel_1/M_AXIS_PHASE]
  connect_bd_intf_net -intf_net Conn2 [get_bd_intf_pins m_axis_signal_B] [get_bd_intf_pins fourier_synthesizer_B/m_axis]
  connect_bd_intf_net -intf_net Conn3 [get_bd_intf_pins M_AXIS_PHASE_B] [get_bd_intf_pins dds_compiler_B_channel_1/M_AXIS_PHASE]
  connect_bd_intf_net -intf_net Conn4 [get_bd_intf_pins m_axis_signal_A] [get_bd_intf_pins fourier_synthesizer_A/m_axis]
  ...
  connect_bd_net -net amplitude_A_channel_1_slice_Dout [get_bd_pins amplitude_A] [get_bd_pins amplitude_A_channel_1_slice/Dout] [get_bd_pins fourier_synthesizer_A/amplitude_channel_1]
  ...
  connect_bd_net -net amplitude_B_channel_1_slice_Dout [get_bd_pins amplitude_B] [get_bd_pins amplitude_B_channel_1_slice/Dout] [get_bd_pins fourier_synthesizer_B/amplitude_channel_1]
...
proc create_hier_cell_fourier_synth_rasterized { parentCell nameHier } {
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins m_axis_signal_A] [get_bd_intf_pins fourier_synthesizer_A/m_axis]
  connect_bd_intf_net -intf_net Conn2 [get_bd_intf_pins m_axis_signal_B] [get_bd_intf_pins fourier_synthesizer_B/m_axis]
  connect_bd_intf_net -intf_net Conn3 [get_bd_intf_pins M_AXIS_PHASE_B] [get_bd_intf_pins dds_compiler_B_channel_1/M_AXIS_PHASE]
  connect_bd_intf_net -intf_net Conn4 [get_bd_intf_pins M_AXIS_PHASE_A] [get_bd_intf_pins dds_compiler_A_channel_1/M_AXIS_PHASE]
  connect_bd_intf_net -intf_net axis_variable_A_channel_1_M_AXIS [get_bd_intf_pins axis_variable_A_channel_1/M_AXIS] [get_bd_intf_pins dds_compiler_A_channel_1/S_AXIS_CONFIG]
  connect_bd_intf_net -intf_net axis_variable_A_channel_2_M_AXIS [get_bd_intf_pins axis_variable_A_channel_2/M_AXIS] [get_bd_intf_pins dds_compiler_A_channel_2/S_AXIS_CONFIG]
  connect_bd_intf_net -intf_net axis_variable_A_channel_3_M_AXIS [get_bd_intf_pins axis_variable_A_channel_3/M_AXIS] [get_bd_intf_pins dds_compiler_A_channel_3/S_AXIS_CONFIG]
  connect_bd_intf_net -intf_net axis_variable_A_channel_4_M_AXIS [get_bd_intf_pins axis_variable_A_channel_4/M_AXIS] [get_bd_intf_pins dds_compiler_A_channel_4/S_AXIS_CONFIG]
...
proc create_hier_cell_system_1 { parentCell nameHier } {
  ...
  connect_bd_net -net axi_cfg_register_cfg_cfg_data [get_bd_pins cfg_data] [get_bd_pins axi_cfg_register_cfg/cfg_data]
...
proc create_hier_cell_DDS { parentCell nameHier } {
  ...
  create_bd_pin -dir I -type clk aclk
  create_bd_pin -dir I -type rst aresetn
  create_bd_pin -dir I -from 63 -to 0 cfg_data
  create_bd_pin -dir I -from 639 -to 0 dac_cfg

  # Create instance: fourier_synth_rasterized
  create_hier_cell_fourier_synth_rasterized $hier_obj fourier_synth_rasterized

  # Create instance: fourier_synth_standard
  create_hier_cell_fourier_synth_standard $hier_obj fourier_synth_standard
  ...
  connect_bd_intf_net -intf_net fourier_synth_rasterized_m_axis_signal_A [get_bd_intf_pins fourier_synth_rasterized/m_axis_signal_A] [get_bd_intf_pins signal_generator_0/s_axis_rasterized_A]
  connect_bd_intf_net -intf_net fourier_synth_rasterized_m_axis_signal_B [get_bd_intf_pins fourier_synth_rasterized/m_axis_signal_B] [get_bd_intf_pins signal_generator_0/s_axis_rasterized_B]
  connect_bd_intf_net -intf_net fourier_synth_standard_M_AXIS_PHASE_A [get_bd_intf_pins fourier_synth_standard/M_AXIS_PHASE_A] [get_bd_intf_pins signal_generator_0/s_axis_phase_standard_A]
  connect_bd_intf_net -intf_net fourier_synth_standard_M_AXIS_PHASE_B [get_bd_intf_pins fourier_synth_standard/M_AXIS_PHASE_B] [get_bd_intf_pins signal_generator_0/s_axis_phase_standard_B]
  connect_bd_intf_net -intf_net fourier_synth_standard_m_axis_signal_A [get_bd_intf_pins fourier_synth_standard/m_axis_signal_A] [get_bd_intf_pins signal_generator_0/s_axis_standard_A]
  connect_bd_intf_net -intf_net fourier_synth_standard_m_axis_signal_B [get_bd_intf_pins fourier_synth_standard/m_axis_signal_B] [get_bd_intf_pins signal_generator_0/s_axis_standard_B]
  connect_bd_intf_net -intf_net signal_generator_0_m_axis [get_bd_intf_pins m_axis] [get_bd_intf_pins signal_generator_0/m_axis]

  # Create port connections
  connect_bd_net -net cfg_data_1 [get_bd_pins cfg_data] [get_bd_pins signal_generator_0/cfg_data]
  connect_bd_net -net clk_wiz_0_clk_internal [get_bd_pins aclk] [get_bd_pins fourier_synth_rasterized/aclk] [get_bd_pins fourier_synth_standard/aclk] [get_bd_pins signal_generator_0/clk]
  connect_bd_net -net fourier_synth_standard_amplitude_A [get_bd_pins fourier_synth_standard/amplitude_A] [get_bd_pins signal_generator_0/amplitude_A]
  connect_bd_net -net fourier_synth_standard_amplitude_B [get_bd_pins fourier_synth_standard/amplitude_B] [get_bd_pins signal_generator_0/amplitude_B]
  connect_bd_net -net proc_sys_reset_fourier_synth_peripheral_aresetn [get_bd_pins aresetn] [get_bd_pins fourier_synth_rasterized/aresetn] [get_bd_pins fourier_synth_standard/aresetn] [get_bd_pins signal_generator_0/aresetn]
  connect_bd_net -net system_cfg_data [get_bd_pins dac_cfg] [get_bd_pins fourier_synth_rasterized/cfg_data] [get_bd_pins fourier_synth_standard/cfg_data]
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.CLKOUT4_REQUESTED_OUT_FREQ {7.812} \
  ...
  # Create instance: xlslice_reset_cfg, and set properties
  set xlslice_reset_cfg [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 xlslice_reset_cfg ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {11} \
   CONFIG.DIN_TO {8} \
   CONFIG.DIN_WIDTH {64} \
  ...
  connect_bd_intf_net -intf_net axis_select_1_m_axis [get_bd_intf_pins DDS/m_axis] [get_bd_intf_pins axis_red_pitaya_dac_0/S_AXIS]
  ...
  connect_bd_net -net Net6 [get_bd_ports ext_DIO6_N] [get_bd_pins dio_0/DIO_0]
  connect_bd_net -net Net7 [get_bd_ports ext_DIO6_P] [get_bd_pins dio_0/DIO_1]
  connect_bd_net -net Net8 [get_bd_ports ext_DIO7_N] [get_bd_pins dio_0/DIO_2]
  connect_bd_net -net Net9 [get_bd_ports ext_DIO7_P] [get_bd_pins dio_0/DIO_3]
  ...
  connect_bd_net -net axis_red_pitaya_adc_0_adc_clk [get_bd_pins axis_red_pitaya_adc_0/adc_clk] [get_bd_pins clk_wiz_2/clk_in1]
  ...
  connect_bd_net -net clk_wiz_0_clk_ddr [get_bd_pins axis_red_pitaya_dac_0/ddr_clk] [get_bd_pins clk_wiz_2/clk_ddr] [get_bd_pins pdm/ddr_clk]
  connect_bd_net -net clk_wiz_0_clk_internal [get_bd_pins DDS/aclk] [get_bd_pins axis_red_pitaya_dac_0/aclk] [get_bd_pins clk_wiz_2/clk_internal] [get_bd_pins dio_0/clk] [get_bd_pins pdm/aclk] [get_bd_pins proc_sys_reset_fourier_synth/slowest_sync_clk] [get_bd_pins proc_sys_reset_pdm/slowest_sync_clk] [get_bd_pins proc_sys_reset_write_to_ram/slowest_sync_clk] [get_bd_pins proc_sys_reset_xadc/slowest_sync_clk] [get_bd_pins reset_manager_0/clk] [get_bd_pins selectio_wiz_1/clk_in] [get_bd_pins system/S_AXI_HP0_ACLK] [get_bd_pins util_ds_buf_0/OBUF_IN] [get_bd_pins write_to_ram/aclk] [get_bd_pins xadc_wiz_0/s_axi_aclk]
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins axis_red_pitaya_dac_0/locked] [get_bd_pins clk_wiz_2/locked] [get_bd_pins selectio_wiz_1/clock_enable] [get_bd_pins system/dcm_locked]
  connect_bd_net -net clk_wiz_1_clk_out1 [get_bd_pins clk_wiz_1/clk_out1] [get_bd_pins clk_wiz_2/clk_in2]
  connect_bd_net -net clk_wiz_1_locked [get_bd_pins clk_wiz_1/locked] [get_bd_pins util_vector_logic_0/Op1]
  connect_bd_net -net clk_wiz_2_clk_pdm [get_bd_pins clk_div_0/clk] [get_bd_pins clk_wiz_2/clk_pdm]
  ...
  connect_bd_net -net proc_sys_reset_fourier_synth_peripheral_aresetn [get_bd_pins DDS/aresetn] [get_bd_pins proc_sys_reset_fourier_synth/peripheral_aresetn]
  ...
  connect_bd_net -net system_cfg_data [get_bd_pins DDS/dac_cfg] [get_bd_pins system/dac_cfg]
  connect_bd_net -net system_cfg_data1 [get_bd_pins DDS/cfg_data] [get_bd_pins system/cfg_data] [get_bd_pins xlslice_0/Din] [get_bd_pins xlslice_2/Din] [get_bd_pins xlslice_reset_cfg/Din]
  ...
  connect_bd_net -net xlconcat_0_dout2 [get_bd_pins dio_0/value] [get_bd_pins xlconcat_0/dout]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins clk_wiz_2/clk_in_sel] [get_bd_pins xlconstant_masterslave/dout]
  ...
  connect_bd_net -net xlconstant_5_dout [get_bd_pins clk_wiz_1/reset] [get_bd_pins clk_wiz_2/reset] [get_bd_pins util_vector_logic_1/Res]
  ...
  connect_bd_net -net xlslice_3_Dout [get_bd_pins reset_manager_0/reset_cfg] [get_bd_pins xlslice_reset_cfg/Dout]
