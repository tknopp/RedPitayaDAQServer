...
# module references:
# reset_manager, rp_iobuf, rp_iobuf, rp_iobuf, rp_iobuf, rp_iobuf, rp_iobuf, rp_iobuf, counter_delayed_trigger, rp_iobuf, enable_ramping_slice, sequence_slice, sequence_stepper, signal_cfg_slice, signal_composer, signal_cfg_slice, signal_composer, wave_awg_composer, wave_awg_composer
...
proc create_hier_cell_signal_compose1 { parentCell nameHier } {
  ...
  connect_bd_net -net signal_cfg_slice_0_comp_3_freq [get_bd_pins signal_cfg_slice_0/comp_3_freq] [get_bd_pins waveform_awg1/freq] [get_bd_pins waveform_gen_3/freq]
  connect_bd_net -net signal_cfg_slice_0_comp_3_phase [get_bd_pins signal_cfg_slice_0/comp_3_phase] [get_bd_pins waveform_awg1/phase] [get_bd_pins waveform_gen_3/phase]
...
proc create_hier_cell_signal_compose { parentCell nameHier } {
  ...
  connect_bd_net -net signal_cfg_slice_0_comp_3_amp [get_bd_pins signal_cfg_slice_0/comp_3_amp] [get_bd_pins waveform_gen_3/amplitude]
  connect_bd_net -net signal_cfg_slice_0_comp_3_cfg [get_bd_pins signal_cfg_slice_0/comp_3_cfg] [get_bd_pins waveform_gen_3/cfg_data]
  connect_bd_net -net signal_cfg_slice_0_comp_3_freq [get_bd_pins signal_cfg_slice_0/comp_3_freq] [get_bd_pins waveform_awg/freq] [get_bd_pins waveform_gen_3/freq]
  connect_bd_net -net signal_cfg_slice_0_comp_3_phase [get_bd_pins signal_cfg_slice_0/comp_3_phase] [get_bd_pins waveform_awg/phase] [get_bd_pins waveform_gen_3/phase]
  connect_bd_net -net signal_cfg_slice_0_offset [get_bd_pins signal_cfg_slice_0/offset] [get_bd_pins signal_composer_0/offset]
...
proc create_hier_cell_system_1 { parentCell nameHier } {
  ...
  # Create instance: axi_cfg_register_axi_sts_register_counter_trigger, and set properties
  set axi_cfg_register_axi_sts_register_counter_trigger [ create_bd_cell -type ip -vlnv pavel-demin:user:axi_cfg_register:1.0 axi_cfg_register_axi_sts_register_counter_trigger ]
  set_property -dict [ list \
   CONFIG.AXI_ADDR_WIDTH {32} \
   CONFIG.CFG_DATA_WIDTH {96} \
 ] $axi_cfg_register_axi_sts_register_counter_trigger
...
unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned} \
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M08_AXI [get_bd_intf_pins axi_cfg_register_axi_sts_register_counter_trigger/S_AXI] [get_bd_intf_pins axi_interconnect_0/M08_AXI]
  ...
  connect_bd_net -net axi_cfg_register_axi_sts_register_counter_trigger_cfg_data [get_bd_pins counter_trigger_cfg] [get_bd_pins axi_cfg_register_axi_sts_register_counter_trigger/cfg_data]
  connect_bd_net -net clk_wiz_0_clk_internal [get_bd_pins S_AXI_HP0_ACLK] [get_bd_pins axi_cfg_register_axi_sts_register_counter_trigger/aclk] [get_bd_pins axi_cfg_register_cfg/aclk] [get_bd_pins axi_cfg_register_dac/aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/M03_ACLK] [get_bd_pins axi_interconnect_0/M04_ACLK] [get_bd_pins axi_interconnect_0/M05_ACLK] [get_bd_pins axi_interconnect_0/M06_ACLK] [get_bd_pins axi_interconnect_0/M07_ACLK] [get_bd_pins axi_interconnect_0/M08_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_1/ACLK] [get_bd_pins axi_interconnect_1/M00_ACLK] [get_bd_pins axi_interconnect_1/M01_ACLK] [get_bd_pins axi_interconnect_1/M02_ACLK] [get_bd_pins axi_interconnect_1/S00_ACLK] [get_bd_pins axi_sts_register_DIOIn/aclk] [get_bd_pins axi_sts_register_adc/aclk] [get_bd_pins axi_sts_register_counter_trigger/aclk] [get_bd_pins axi_sts_register_pdm/aclk] [get_bd_pins axi_sts_register_reset/aclk] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/M_AXI_GP1_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins rst_ps7_0_125M/slowest_sync_clk]
...
proc create_hier_cell_counter_trigger { parentCell nameHier } {
  ...
  create_bd_pin -dir IO counter_reset
  ...
  # Create instance: rp_iobuf_0, and set properties
  set block_name rp_iobuf
  set block_cell_name rp_iobuf_0
  if { [catch {set rp_iobuf_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $rp_iobuf_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  # Create port connections
  connect_bd_net -net Net [get_bd_pins counter_reset] [get_bd_pins rp_iobuf_0/val_tri]
  connect_bd_net -net aresetn_1 [get_bd_pins aresetn] [get_bd_pins counter_delayed_trig_0/aresetn]
  connect_bd_net -net clk_1 [get_bd_pins clk] [get_bd_pins counter_delayed_trig_0/clk] [get_bd_pins rp_iobuf_0/clk]
  ...
  connect_bd_net -net counter_delayed_trig_0_trigger [get_bd_pins counter_trigger] [get_bd_pins counter_delayed_trig_0/trigger]
  connect_bd_net -net counter_delayed_trig_0_trigger_armed [get_bd_pins counter_delayed_trig_0/trigger_armed] [get_bd_pins xlconcat_1/In1]
  connect_bd_net -net rp_iobuf_0_val_in_clocked [get_bd_pins counter_delayed_trig_0/counter_reset] [get_bd_pins rp_iobuf_0/val_in_clocked]
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_pins rp_iobuf_0/direction] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins rp_iobuf_0/val_out] [get_bd_pins xlconstant_1/dout]
  connect_bd_net -net xlconstant_2_dout [get_bd_pins xlconcat_1/In2] [get_bd_pins xlconstant_2/dout]
  connect_bd_net -net xlslice_0_Dout [get_bd_pins counter_delayed_trig_0/trigger_reset] [get_bd_pins xlslice_0/Dout]
  connect_bd_net -net xlslice_10_Dout [get_bd_pins counter_delayed_trig_0/enable] [get_bd_pins xlslice_10/Dout]
  ...
  connect_bd_net -net xlslice_9_Dout [get_bd_pins counter_delayed_trig_0/trigger_arm] [get_bd_pins xlslice_9/Dout]
...
proc create_hier_cell_DIO { parentCell nameHier } {
  ...
  # Create pins
  create_bd_pin -dir I -from 95 -to 0 Din
  ...
  # Create instance: rp_iobuf_1, and set properties
  set block_name rp_iobuf
  set block_cell_name rp_iobuf_1
  if { [catch {set rp_iobuf_1 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $rp_iobuf_1 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_net -net Net6 [get_bd_pins ext_DIO7_P] [get_bd_pins rp_iobuf_0/val_tri]
  connect_bd_net -net Net7 [get_bd_pins ext_DIO7_N] [get_bd_pins rp_iobuf_1/val_tri]
  connect_bd_net -net clk_wiz_0_clk_internal [get_bd_pins clk] [get_bd_pins rp_iobuf_0/clk] [get_bd_pins rp_iobuf_1/clk] [get_bd_pins rp_iobuf_2/clk] [get_bd_pins rp_iobuf_3/clk] [get_bd_pins rp_iobuf_4/clk] [get_bd_pins rp_iobuf_5/clk] [get_bd_pins rp_iobuf_6/clk]
  connect_bd_net -net rp_iobuf_0_val_in_clocked [get_bd_pins rp_iobuf_0/val_in_clocked] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net rp_iobuf_1_val_in_clocked [get_bd_pins rp_iobuf_1/val_in_clocked] [get_bd_pins xlconcat_0/In1]
  ...
  connect_bd_net -net system_cfg_data1 [get_bd_pins Din] [get_bd_pins xlslice_4/Din] [get_bd_pins xlslice_5/Din]
  connect_bd_net -net xlconcat_0_dout2 [get_bd_pins dout] [get_bd_pins xlconcat_0/dout]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins xlconcat_0/In8] [get_bd_pins xlconstant_1/dout]
  connect_bd_net -net xlconstant_2_dout [get_bd_pins xlconcat_0/In7] [get_bd_pins xlconstant_2/dout]
  connect_bd_net -net xlslice_0_Dout [get_bd_pins rp_iobuf_0/val_out] [get_bd_pins xlslice_0/Dout]
  connect_bd_net -net xlslice_10_Dout [get_bd_pins rp_iobuf_2/val_out] [get_bd_pins xlslice_10/Dout]
  connect_bd_net -net xlslice_11_Dout [get_bd_pins rp_iobuf_3/val_out] [get_bd_pins xlslice_11/Dout]
  ...
  connect_bd_net -net xlslice_4_Dout [get_bd_pins xlslice_0/Din] [get_bd_pins xlslice_10/Din] [get_bd_pins xlslice_11/Din] [get_bd_pins xlslice_12/Din] [get_bd_pins xlslice_15/Din] [get_bd_pins xlslice_4/Dout] [get_bd_pins xlslice_6/Din] [get_bd_pins xlslice_9/Din]
  connect_bd_net -net xlslice_5_Dout [get_bd_pins xlslice_1/Din] [get_bd_pins xlslice_13/Din] [get_bd_pins xlslice_14/Din] [get_bd_pins xlslice_2/Din] [get_bd_pins xlslice_3/Din] [get_bd_pins xlslice_5/Dout] [get_bd_pins xlslice_7/Din] [get_bd_pins xlslice_8/Din]
  ...
  connect_bd_net -net xlslice_8_Dout [get_bd_pins rp_iobuf_1/direction] [get_bd_pins xlslice_8/Dout]
  connect_bd_net -net xlslice_9_Dout [get_bd_pins rp_iobuf_1/val_out] [get_bd_pins xlslice_9/Dout]
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net Net6 [get_bd_ports ext_DIO7_P] [get_bd_pins DIO/ext_DIO7_P]
  connect_bd_net -net Net7 [get_bd_ports ext_DIO7_N] [get_bd_pins DIO/ext_DIO7_N]
  ...
  connect_bd_net -net Net13 [get_bd_ports ext_DIO2_N] [get_bd_pins counter_trigger/counter_reset]
  ...
  connect_bd_net -net system_cfg_data1 [get_bd_pins DIO/Din] [get_bd_pins system/cfg_data] [get_bd_pins xlslice_1/Din] [get_bd_pins xlslice_2/Din] [get_bd_pins xlslice_3/Din] [get_bd_pins xlslice_6/Din]
  ...
  connect_bd_net -net xlconcat_0_dout2 [get_bd_pins DIO/dout] [get_bd_pins system/sts_data]
  ...
  assign_bd_address -offset 0x40008000 -range 0x00001000 -target_address_space [get_bd_addr_spaces system/processing_system7_0/Data] [get_bd_addr_segs system/axi_cfg_register_axi_sts_register_counter_trigger/s_axi/reg0] -force
