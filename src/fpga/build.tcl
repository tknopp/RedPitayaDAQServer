...
# module references:
# incremental_encoder, reset_manager
...
proc create_hier_cell_system_1 { parentCell nameHier } {
  ...
  create_bd_pin -dir I -from 15 -to 0 inc_enc_counter
  create_bd_pin -dir I -from 7 -to 0 inc_enc_data
...
CONFIG.NUM_WRITE_OUTSTANDING {1} \
  ...
  # Create instance: axi_sts_register_inc_enc_counter, and set properties
  set axi_sts_register_inc_enc_counter [ create_bd_cell -type ip -vlnv pavel-demin:user:axi_sts_register:1.0 axi_sts_register_inc_enc_counter ]
  set_property -dict [ list \
CONFIG.AXI_ADDR_WIDTH {32} \
CONFIG.STS_DATA_WIDTH {16} \
 ] $axi_sts_register_inc_enc_counter

  set_property -dict [ list \
CONFIG.NUM_READ_OUTSTANDING {1} \
CONFIG.NUM_WRITE_OUTSTANDING {1} \
 ] [get_bd_intf_pins /system/axi_sts_register_inc_enc_counter/S_AXI]

  # Create instance: axi_sts_register_inc_enc_data, and set properties
  set axi_sts_register_inc_enc_data [ create_bd_cell -type ip -vlnv pavel-demin:user:axi_sts_register:1.0 axi_sts_register_inc_enc_data ]
  set_property -dict [ list \
CONFIG.AXI_ADDR_WIDTH {32} \
CONFIG.STS_DATA_WIDTH {8} \
 ] $axi_sts_register_inc_enc_data

  set_property -dict [ list \
CONFIG.NUM_READ_OUTSTANDING {1} \
CONFIG.NUM_WRITE_OUTSTANDING {1} \
 ] [get_bd_intf_pins /system/axi_sts_register_inc_enc_data/S_AXI]
...
CONFIG.PCW_USE_S_AXI_HP1 {0} \
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M07_AXI [get_bd_intf_pins axi_interconnect_0/M07_AXI] [get_bd_intf_pins axi_sts_register_inc_enc_data/S_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M08_AXI [get_bd_intf_pins axi_interconnect_0/M08_AXI] [get_bd_intf_pins axi_sts_register_inc_enc_counter/S_AXI]
  ...
  connect_bd_net -net sts_data_2 [get_bd_pins inc_enc_counter] [get_bd_pins axi_sts_register_inc_enc_counter/sts_data]
  connect_bd_net -net sts_data_3 [get_bd_pins inc_enc_data] [get_bd_pins axi_sts_register_inc_enc_data/sts_data]
...
CONFIG.TDATA_NUM_BYTES {4} \
  ...
  # Create instance: clk_div_inc_encoder, and set properties
  set clk_div_inc_encoder [ create_bd_cell -type ip -vlnv referencedesigner.com:user:clk_div:1.0 clk_div_inc_encoder ]
  set_property -dict [ list \
CONFIG.N {500} \
 ] $clk_div_inc_encoder

  # Create instance: clk_div_pdm, and set properties
  set clk_div_pdm [ create_bd_cell -type ip -vlnv referencedesigner.com:user:clk_div:1.0 clk_div_pdm ]
...
CONFIG.PRIM_IN_FREQ {125.000} \
  ...
  set block_name incremental_encoder
  set block_cell_name incremental_encoder_0
  if { [catch {set incremental_encoder_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $incremental_encoder_0 eq "" } {
...
CONFIG.XADC_STARUP_SELECTION {independent_adc} \
  ...
  # Create instance: xlconcat_inc_encoder, and set properties
  set xlconcat_inc_encoder [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 xlconcat_inc_encoder ]
  set_property -dict [ list \
CONFIG.IN0_WIDTH {2} \
CONFIG.IN1_WIDTH {6} \
 ] $xlconcat_inc_encoder
...
CONFIG.CONST_VAL {0} \
  ...
  # Create instance: xlconstant_fill_inc_encoder, and set properties
  set xlconstant_fill_inc_encoder [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 xlconstant_fill_inc_encoder ]
  set_property -dict [ list \
CONFIG.CONST_VAL {0} \
CONFIG.CONST_WIDTH {6} \
 ] $xlconstant_fill_inc_encoder

  # Create instance: xlconstant_inc_enc_reset, and set properties
  set xlconstant_inc_enc_reset [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 xlconstant_inc_enc_reset ]
  set_property -dict [ list \
CONFIG.CONST_VAL {0} \
 ] $xlconstant_inc_enc_reset

  # Create instance: xlconstant_pdm_clk_reset, and set properties
  set xlconstant_pdm_clk_reset [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 xlconstant_pdm_clk_reset ]
  set_property -dict [ list \
CONFIG.CONST_VAL {0} \
 ] $xlconstant_pdm_clk_reset
...
CONFIG.DOUT_WIDTH {8} \
  ...
  connect_bd_net -net Net6 [get_bd_ports ext_DIO6_P] [get_bd_pins incremental_encoder_0/incremental_encoder_1]
  connect_bd_net -net Net7 [get_bd_ports ext_DIO7_P] [get_bd_pins incremental_encoder_0/incremental_encoder_2]
  ...
  connect_bd_net -net clk_div_0_clk_out [get_bd_pins clk_div_pdm/clk_out] [get_bd_pins pdm/pdm_clk]
  connect_bd_net -net clk_div_1_clk_out [get_bd_pins clk_div_inc_encoder/clk_out] [get_bd_pins incremental_encoder_0/clk]
  ...
  connect_bd_net -net incremental_encoder_0_counter [get_bd_pins incremental_encoder_0/counter] [get_bd_pins system/inc_enc_counter]
  connect_bd_net -net incremental_encoder_0_data [get_bd_pins incremental_encoder_0/data] [get_bd_pins xlconcat_inc_encoder/In0]
  ...
  connect_bd_net -net system_peripheral_aresetn [get_bd_pins incremental_encoder_0/aresetn] [get_bd_pins reset_manager_0/peripheral_aresetn] [get_bd_pins system/peripheral_aresetn]
  ...
  connect_bd_net -net xlconcat_0_dout2 [get_bd_ports led_o] [get_bd_pins system/inc_enc_data] [get_bd_pins xlconcat_inc_encoder/dout]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins clk_wiz_0/clk_in_sel] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlconstant_2_dout [get_bd_pins clk_div_pdm/reset] [get_bd_pins xlconstant_pdm_clk_reset/dout]
  connect_bd_net -net xlconstant_2_dout1 [get_bd_pins clk_div_inc_encoder/reset] [get_bd_pins xlconstant_inc_enc_reset/dout]
  ...
  connect_bd_net -net xlconstant_fill_inc_encoder_dout [get_bd_pins xlconcat_inc_encoder/In1] [get_bd_pins xlconstant_fill_inc_encoder/dout]
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0x40007000 [get_bd_addr_spaces system/processing_system7_0/Data] [get_bd_addr_segs system/axi_sts_register_inc_enc_counter/s_axi/reg0] SEG_axi_sts_register_inc_enc_counter_reg0
  create_bd_addr_seg -range 0x00001000 -offset 0x40006000 [get_bd_addr_spaces system/processing_system7_0/Data] [get_bd_addr_segs system/axi_sts_register_inc_enc_data/s_axi/reg0] SEG_axi_sts_register_inc_enc_data_reg0
