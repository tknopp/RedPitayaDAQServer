...
core_parameter AXIS_TDATA_PHASE_STANDARD_WIDTH {AXIS_TDATA_PHASE_STANDARD_WIDTH} {Width of the phase data from standard DDS Compiler.}
core_parameter AXIS_TDATA_PHASE_RASTERIZED_WIDTH {AXIS_TDATA_PHASE_RASTERIZED_WIDTH} {Width of the phase data from rasterized DDS Compiler.}
