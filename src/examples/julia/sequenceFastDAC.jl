...
seq = ArbitrarySequence(lut, nothing, slow_dac_periods_per_frame, 1, 0.0, 0.0)
...
seq2 = ConstantSequence([-0.2], nothing, slow_dac_periods_per_frame, 1, 0.0, 0.0)
config2 = fastDACConfig(seq2)
# Only updates values
amplitudeDAC(config2, 1, 1, 0.1)
appendSequence(master(rp), seq2)

seq3 = ConstantSequence([-0.2], nothing , slow_dac_periods_per_frame, 1, 0.0, 0.0)
